        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
          {/* Carrito */}
            <div className="flex flex-col mt-5">
              <div className={
                clsx(
                  "flex items-center rounded-lg py-2 px-3.5 text-xs font-bold text-white mbg-5",
                  {
                    'bg-red-500': false,
                    'bg-green-700': true
                  }
          ...
          {/* Checkout Resumen de orden */}
            <div className="bg-white rounded-xl shadow-xl p-7">
              ...
              <div className="mb-10">
                <p className="text-xl">Luis Martinez</p>
                <p>Av. San Ingacio 1848</p>
                <p>Col. Jardines de San Manuel</p>
                <p>Puebla de Zaragoza</p>
                <p>Puebla</p>
                <p>CP: 72570</p>
                <p>9535939919</p>
              </div>
